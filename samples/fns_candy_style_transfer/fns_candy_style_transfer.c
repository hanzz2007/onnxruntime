...
int main(int argc, char* argv[]) {
  ...
  g_ort->SetOptimizedModelFilePath(session_options, "./fns_candy_opt.onnx");
  g_ort->SetSessionLogSeverityLevel(session_options, 0);
  g_ort->SetSessionLogVerbosityLevel(session_options, 0);
  g_ort->SetSessionGraphOptimizationLevel(session_options, 0);
